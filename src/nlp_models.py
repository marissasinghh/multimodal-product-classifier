...
class GPT:
    ...
    def get_embedding(self, text):
        ...
        # Text preprocessing if needed (e.g., removing newlines)
        text = text.replace("\n", " ")
    ...
    def get_embedding_df(self, column, directory, file):
        ...
        # Use a lambda function to apply the `get_embedding` method to each row in the column
...
class HuggingFaceEmbeddings:
    ...
    def get_embedding(self, text):
        ...
        # Resulting tensor has shape [batch_size, hidden_size]
